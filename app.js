...
function addTodo() {
  if (input.value === "") {
    Swal.fire({
      ...
      footer:
        '<a href="#">Stuck? Time to phone a friend or ask the universe!</a>',
    ...
    deleteButton.onclick = function () {
      //eger butona tiklanirsa span elementi olarak atadim baslangic icin en sonda olusturdugumuz lielementini silsin diyoruz.
